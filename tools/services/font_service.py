...
class DesignContext:
    ...
    def _create_builder(self, width_mode: WidthMode, language_flavor: LanguageFlavor) -> FontBuilder:
        ...
        builder.meta_info.family_name = f'Mixed MaruMinya {self.font_size}px {width_mode[:4].capitalize()} {language_flavor}'
        ...
        builder.meta_info.designer = 'Pixel Font Studio'
        builder.meta_info.description = 'Open source Pan-CJK pixel font'
        builder.meta_info.copyright_info = 'Copyright (c) 2026, Pixel Font Studio (https://github.com/pixel-font-studio)'
        builder.meta_info.license_info = 'This Font Software is licensed under the SIL Open Font License, Version 1.1'
        builder.meta_info.vendor_url = 'https://pixel-font-studio.github.io/mixed-maruminya-pixel-font'
        builder.meta_info.designer_url = 'https://github.com/pixel-font-studio'
        builder.meta_info.license_url = 'https://github.com/pixel-font-studio/mixed-maruminya-pixel-font/blob/master/LICENSE-OFL'
        ...
        if len(font_formats) > 0:
            for language_flavor in options.language_flavors:
                ...
                for font_format in font_formats:
                    file_path = path_define.outputs_dir.joinpath(f'mixed-maruminya-{self.font_size}px-{width_mode}-{language_flavor}.{font_format}')
